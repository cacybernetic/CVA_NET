...
from .model import AlexNetBackbone, JEPA, Config
from .factory import jepa


def _write_json_file(data_dict: Dict[str, Any], file_path: str, encoding: str='utf-8', indent=2) -> None:
...
def load(dir_path: str, encoding: str='utf-8') -> Tuple[AlexNetBackbone, Config]:
    assert not dir_path, (
