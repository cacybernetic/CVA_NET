...
def iou(boxes_preds: torch.Tensor, boxes_labels: torch.Tensor, box_format: str="midpoint") -> torch.Tensor:
    """
...
class YOLOLoss(nn.Module):
    ...
    def forward(
        ...
        #print(self.lambda_pobj * object_loss)
        #print(self.lambda_noobj * no_object_loss)
        #print(self.lambda_class * class_loss)
        #print("\n")
        return {
            'box_loss': self.lambda_box * box_loss,
            'pobj_loss': self.lambda_pobj * object_loss,
            'noobj_loss': self.lambda_noobj * no_object_loss,
            'cls_loss': self.lambda_class * class_loss,
            }
